        ...
        <div class="row gutters-10">
            ...
            <div class="col-xl col-md-6">
                <div class="mb-3 mb-lg-0">
                    <a href="https://marketplace.suksesbergilir.com/public/uploads/all/RsheBltZg9LJX7axMcXgiOTVD3tcc6TcMbc4ysV9.jpg"
                        class="d-block text-reset">
                        <img src="https://marketplace.suksesbergilir.com/public/uploads/all/RsheBltZg9LJX7axMcXgiOTVD3tcc6TcMbc4ysV9.jpg"
                            data-src="https://marketplace.suksesbergilir.com/public/uploads/all/RsheBltZg9LJX7axMcXgiOTVD3tcc6TcMbc4ysV9.jpg"
    ...
    <div class="container">
        <div class="row gutters-10 position-relative">
            ...
            <div class="@if($num_todays_deal > 0) col-lg-7 @else col-lg-9 @endif">
                ...
                @php
                $halfCount = count($featured_categories) / 2;
                @endphp

                <ul class="list-unstyled mb-0 row gutters-6" test-data-start>
                    @foreach ($featured_categories as $key => $category)
                    @if ($key < $halfCount) @for ($i=0; $i < 2; $i++) <li class="minw-0 col-4 col-md mt-3">
                        <a href="{{ route('products.category', $category->slug) }}"
                            class="d-block rounded bg-white p-2 text-reset shadow-sm">
                            <img src="{{ static_asset('assets/img/placeholder.jpg') }}"
                                data-src="{{ uploaded_asset($category->banner) }}"
                                alt="{{ $category->getTranslation('name') }}" class="lazyload img-fit" height="78"
                                onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';">
                            <div class="text-truncate fs-12 fw-600 mt-2 opacity-70">{{ $category->getTranslation('name')
                                }}</div>
                        </a>
                        </li>
                        @endfor
                ...
                <ul class="list-unstyled mb-0 row gutters-6" adafad>
                    @foreach ($featured_categories as $key => $category)
                    @if ($key >= $halfCount)
                    @for ($i = 0; $i < 2; $i++) <li class="minw-0 col-4 col-md mt-3">
                        <a href="{{ route('products.category', $category->slug) }}"
                            class="d-block rounded bg-white p-2 text-reset shadow-sm">
                            <img src="{{ static_asset('assets/img/placeholder.jpg') }}"
                                data-src="{{ uploaded_asset($category->banner) }}"
                            ...
                            <div class="col mb-2">
                                <a href="{{ route('product', $product->slug) }}"
                                    ...
                                    <div class="row gutters-5 align-items-center">
                                        ...
                                        <div class="col-xxl">
                                            <div class="fs-16">
                                                <span class="d-block text-primary fw-600">{{
    ...
    <section class="mb-4">
        <div class="container">
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                ...
                <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="10" data-xl-items="10"
                    data-lg-items="10" data-md-items="5" data-sm-items="2" data-xs-items="2" data-arrows='true'>
        ...
        <section class="mb-4">
            <div class="container">
                <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                    ...
                    <!--<div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="6" data-lg-items="4"  data-md-items="3" data-sm-items="3" data-xs-items="3" data-arrows='true'>-->
                    <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="6"
                        data-lg-items="6" data-md-items="6" data-sm-items="2" data-xs-items="2" data-arrows='true'>
        ...
        <section class="mb-4">
            <div class="container">
                <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                    ...
                    <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="6"
                        data-lg-items="6" data-md-items="3" data-sm-items="3" data-xs-items="3" data-arrows='true'>
                        @foreach ($newest_products as $key => $new_product)
                        <div class="carousel-box">
                            @include('frontend.partials.product_box_1',['product' => $new_product])
                        </div>
