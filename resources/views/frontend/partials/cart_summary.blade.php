<div class="card rounded border-0 shadow-sm">
    <div class="card-header">
        ...
        <div class="text-right">
            ...
            @foreach ($carts as $key => $cartItem)
            @php $subtotal_for_min_order_amount += cart_product_price($cartItem, $cartItem->product, false, false) *
            $cartItem['quantity']; @endphp
            @endforeach

            @if (get_setting('minimum_order_amount_check') == 1 && $subtotal_for_min_order_amount <
                get_setting('minimum_order_amount')) <span class="badge badge-inline badge-primary">
            ...
            <tbody>
                ...
                <tr class="cart_item">
                    ...
                    <td class="product-total text-right">
                        <span class="pl-4 pr-0">{{ single_price(cart_product_price($cartItem, $cartItem->product, false,
                            false) * $cartItem['quantity']) }}</span>
                    </td>
                </tr>
                @endforeach
            </tbody>
        ...
        <table class="table">
            ...
            <tfoot>
                ...
                <tr class="cart-total">
                    ...
                    <td class="text-right">
                        <strong><span id="_total" data-total="{{ $total }}">{{ single_price($total) }}</span></strong>
                    </td>
                </tr>
            </tfoot>
        </table>
        ...
        <div class="mt-3">
            <form class="" id="remove-coupon-form" enctype="multipart/form-data">
                ...
                <div class="input-group">
                    ...
                    <div class="input-group-append">
                        <button type="button" id="coupon-remove" class="btn btn-primary">{{ translate('Change Coupon')
                            }}</button>
                    </div>
                </div>
            </form>
        ...
        <div class="mt-3">
            <form class="" id="apply-coupon-form" enctype="multipart/form-data">
                ...
                <div class="input-group">
                    ...
                    <div class="input-group-append">
                        <button type="button" id="coupon-apply" class="btn btn-primary">{{ translate('Apply')
                            }}</button>
                    </div>
                </div>
            </form>
