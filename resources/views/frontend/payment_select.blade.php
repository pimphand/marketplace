                    ...
                    <div class="card rounded border-0 shadow-sm">
                        ...
                        <div class="card-body text-center">
                                    ...
                                    <div class="row gutters-10">
                                        ...
                                        <div class="col-6 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="cicil" class="online_payment" type="radio"
                                                    name="payment_option">
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('uploads/bank/bca.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('Cicil')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/paypal.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('Paypal')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/stripe.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('Stripe')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/mercadopago.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('Mercadopago')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/sslcommerz.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('sslcommerz')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/instamojo.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('Instamojo')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/rozarpay.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('Razorpay')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/paystack.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('Paystack')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/vogue.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('VoguePay')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/payhere.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('payhere')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/ngenius.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('ngenius')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/iyzico.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('Iyzico')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/nagad.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('Nagad')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/bkash.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('Bkash')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/aamarpay.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('Aamarpay')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/authorizenet.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('Authorize Net')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/payku.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('Payku')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/mpesa.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('mpesa')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/flutterwave.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('flutterwave')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/payfast.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('payfast')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/paytm.jpg') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('Paytm')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/toyyibpay.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('ToyyibPay')
                                                            }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/cod.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span class="d-block fw-600 fs-15">{{ translate('Cash on
                                                            Delivery') }}</span>
                                                    </span>
                                                </span>
                                            </label>
                            ...
                            <div class="py-4 text-center">
                                ...
                                @if (Auth::user()->balance < $total) <button type="button" class="btn btn-secondary"
                                    disabled>
                        ...
                        <div class="form-cicil" style="display: none">
                            <div class="card-header p-3">
                                <h3 class="fs-16 fw-600 mb-0">
                                    {{ translate('Pilih jangka waktu') }}
                                </h3>
                            </div>
                            <div class="card-body text-center">
                                <div class="row">
                                    <div class="col-xxl-8 col-xl-10 mx-auto">
                                        <div class="row gutters-10" id="show-cicil">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function cicil() {
        $('.form-cicil').show()
        var formattedCurrency = $('#_total').data('total');

        let hargaBarang = formattedCurrency//parseFloat(formattedCurrency);
        ...
        let content = `
            <div class="col-6 col-md-4">
                <label class="aiz-megabox d-block mb-3">
                    <input value="cicilan1" class="cicilan_payment" type="radio"
                        name="payment_option"  data-masa-cicilan="1">
                    <span class="d-block aiz-megabox-elem p-3">
                        <img src="{{ static_asset('uploads/bank/bca.png') }}"
                            class="img-fluid mb-2">
                        <span class="d-block text-center">
                            <span class="d-block fw-600 fs-15">{{ translate('Bayar Bulan Depan') }}</span>
                            <span class="d-block">Total Pembayaran: <br> Rp${hitungCicilan(hargaBarang, 1, dpPresentase)}</span>
                        </span>
                    </span>
                </label>
            </div>
        ...
        // Tambahkan opsi cicilan 3 bulan
        content += `
            <div class="col-6 col-md-4">
                <label class="aiz-megabox d-block mb-3">
                    <input value="cicilan3" class="cicilan_payment" type="radio"
                        name="payment_option" data-masa-cicilan="3">
                    <span class="d-block aiz-megabox-elem p-3">
                        <img src="{{ static_asset('uploads/bank/bca.png') }}"
                            class="img-fluid mb-2">
                        <span class="d-block text-center">
                            <span class="d-block fw-600 fs-15">{{ translate('Cicilan 3 Bulan') }}</span>
                            <span class="d-block">Total Pembayaran: <br> Rp${hitungCicilan(hargaBarang, 3, dpPresentase)}</span>
                        </span>
                    </span>
                </label>
            </div>
        ...
        // Tambahkan opsi cicilan 6 bulan
        content += `
            <div class="col-6 col-md-4">
                <label class="aiz-megabox d-block mb-3">
                    <input value="cicilan6" class="cicilan_payment" type="radio"
                        name="payment_option" data-masa-cicilan="6">
                    <span class="d-block aiz-megabox-elem p-3">
                        <img src="{{ static_asset('uploads/bank/bca.png') }}"
                            class="img-fluid mb-2">
                        <span class="d-block text-center">
                            <span class="d-block fw-600 fs-15">{{ translate('Cicilan 6 Bulan') }}</span>
                            <span class="d-block">Total Pembayaran: <br>
                                Rp${hitungCicilan(hargaBarang, 6, dpPresentase)}</span>
                        </span>
                    </span>
                </label>
            </div>
        ...
        $('#show-cicil').html(content);
    }

    function hitungCicilan(harga, masaCicilan, dpPresent) {
        let bunga = 0.04; // 4% bunga
        let dp = dpPresent ? dpPresent * harga : 0;
        let sisaHarga = harga - dp;
        let bungaBulanan = bunga / 1; // Bunga per bulan
        let jumlahCicilan = masaCicilan; // Jumlah total cicilan

        // Rumus angsuran kredit dengan bunga tetap
        let angsuran = (sisaHarga * bungaBulanan) / (1 - Math.pow(1 + bungaBulanan, -jumlahCicilan));

        return angsuran.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
    }
