            ...
            <div class="col-xl-8 mx-auto">
                ...
                <div class="mb-4 bg-white p-4 rounded shadow-sm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>Rp. {{ number_format($combined_order->grand_total + $first_order->fee_payment)
                                        }}
                                    </td>
                                </tr>
                                <tr>
                        ...
                        @if ($first_order->payment_type == 'duitku' && count($first_order->duitku_payment) > 0)
                        <div class="col-md-12">
                            <table class="table">
                                <tr>
                                    <td class="w-50 fw-600">{{ translate('Virtual Account')}}:</td>
                                    <td>{{ $payment->vaNumber }}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="w-50 fw-600">{{ translate('Reference')}}:</td>
                                    <td>{{ $payment->reference }}</td>
                                </tr>
                                <tr>
                                    <td class="w-50 fw-600">{{ translate('Cara pembayaran')}}:</td>
                                    <td>
                                        <a class="text-success" href="{{ $payment->paymentUrl }}" target="_blank">
                                            Klik di sini
                                        </a>
                                    </td>
                                </tr>
                ...
                <div class="card shadow-sm border-0 rounded">
                    <div class="card-body">
                        <div class="text-center py-4 mb-4">
                            <h2 class="h5">{{ translate('Order Code:')}} <span class="fw-700 text-primary">{{
                                    $order->code }}</span></h2>
                        </div>
                        <div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif ($order->shipping_type != null && $order->shipping_type ==
                                                'carrier')
                                                {{ translate('Carrier') }}
                                                @elseif ($order->shipping_type == 'pickup_point')
                                                @if ($order->pickup_point != null)
                                                {{ $order->pickup_point->getTranslation('name') }} ({{ translate('Pickip
                                                Point') }})
                                                @endif
                                                @endif
                                            </td>
                                            <td class="text-right">Rp.{{ number_format($orderDetail->price) }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                                    ...
                                    <table class="table ">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <span class="fw-600">Rp. {{
                                                        number_format($order->orderDetails->sum('price')) }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>{{ translate('Shipping')}}</th>
                                                <td class="text-right">
                                                    <span class="font-italic">Rp. {{
                                                        number_format($order->orderDetails->sum('shipping_cost'))
                                                        }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <span class="font-italic">Rp. {{
                                                        number_format($order->orderDetails->sum('tax')) }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <span class="font-italic">Rp. {{
                                                        number_format($order->coupon_discount)
                                                        }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <span class="font-italic">Rp. {{
                                                        number_format($first_order->fee_payment)
                                                        }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <strong><span>Rp. {{ number_format($order->grand_total +
                                                            $first_order->fee_payment)
                                                            }}</span></strong>
                                                </td>
                                            </tr>
                                        </tbody>
