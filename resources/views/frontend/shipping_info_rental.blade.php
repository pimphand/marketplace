        ...
        <div class="row cols-xs-space cols-sm-space cols-md-space">
            <div class="col-xxl-8 col-xl-10 mx-auto">
                <form class="form-default" data-toggle="validator"
                    action="{{ route('order_confirmed_rental') }}" role="form" method="POST">
                    @csrf
                    @if(Auth::check())
                                    ...
                                    <span class="d-flex p-3 aiz-megabox-elem">
                                        ...
                                        <span class="flex-grow-1 pl-3 text-left">
                                            ...
                                            <div>
                                                ...
                                                <span class="fw-600 ml-2">{{ optional($address->newCity)->city_name
                                                    }}</span>
                                            </div>
                                            <div>
                                                <span class="opacity-60">{{ translate('State') }}:</span>
                                                <span class="fw-600 ml-2">{{ optional($address->newState)->province_name
                                                    }}</span>
                                            </div>
                                            <div>
