                ...
                <form class="form-default" action="{{ route('checkout.store_delivery_info') }}" role="form"
                    ...
                    <div class="card mb-3 shadow-sm border-0 rounded">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex">
                                        ...
                                        <span class="fs-14 opacity-60">{{ $product->getTranslation('name') }}
                                        </span>
                                    </div>
                                </li>
                                @endforeach
                                        ...
                                        <div class="col-6">
                                            <label class="aiz-megabox d-block bg-white mb-0">
                                                ...
                                                <span class="d-flex p-3 aiz-megabox-elem">
                                                    ...
                                                    <span class="flex-grow-1 pl-3 fw-600">{{ translate('Home Delivery')
                                                        }}</span>
                                                </span>
                                            </label>
                                        </div>
                            ...
                            @endif
                            <div class="row pt-3 carrier_id_admin">
                                @foreach($rajaongkir->results as $key => $courier)
                                @foreach ($courier->costs as $service)
                                <div class="col-md-6 mb-2">
                                    <label class="aiz-megabox d-block bg-white mb-0">
                                        <input type="radio" name="shipping" value="{{ $service->cost[0]->value }}">
                                        <span class="d-flex p-3 aiz-megabox-elem">
                                            <span class="aiz-rounded-check flex-shrink-0 mt-1"></span>
                                            <span class="flex-grow-1 pl-3 fw-600">
                                                <img src="{{ asset('public/uploads/courier/'.$courier->code)}}.png"
                                                    alt="Image" class="w-50px img-fit">
                                                <span class="flex-grow-1 pl-3 fw-700">{{ $courier->code }}</span>
                                            </span>

                                            {{-- Radio buttons for selecting service --}}
                                            <div class="flex-grow-1 pl-3">
                                                <label>Service:</label>
                                                <div>
                                                    <label class="d-block mb-2">
                                                        <input type="radio" name="selected_services"
                                                            value="{{ $courier->code }}-{{ $service->service }}"
                                                            id="service_radio_{{ $key }}_{{ $loop->index }}">
                                                        {{ $service->service }} - {{ $service->description }} <br>
                                                        Rp.{{ number_format($service->cost[0]->value,2) }}
                                                    </label>
                                                </div>
                                            </div>
                                        </span>
                            ...
                            <div class="row border-top pt-3">
                                ...
                                <div class="col-md-6">
                                    <div class="row gutters-5">
                                        ...
                                        <div class="col-6">
                                            <label class="aiz-megabox d-block bg-white mb-0">
                                                <input type="radio" name="shipping_type_{{ $key }}" value="pickup_point"
                                                    onchange="show_pickup_point(this, {{ $key }})"
                    ...
                    <div class="pt-4 d-flex justify-content-between align-items-center">
                        ...
                        <button type="submit" class="btn fw-600 btn-primary">{{ translate('Continue to
                            Payment')}}</button>
                    </div>
                </form>
            </div>
