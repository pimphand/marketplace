            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('services.store') }}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select name="type" class="form-control" id="type">
                                <option value="" selected hidden>Pilih Tipe Pekerjaan</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <input type="number" value="0" name="start_salary" class="form-control" required>
                        </div>
                        <div class="col-md-3">
                            <input type="number" value="0" name="end_salary" class="form-control" required>
                        </div>
                        <div class="col-md-3">
                            <select type="number" name="payment_type" class="form-control" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="date" placeholder="{{translate('')}}" name="end_date" class="form-control"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea class="aiz-text-editor" name="qualification"></textarea>
                        </div>
                    </div>
