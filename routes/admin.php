...
use App\Http\Controllers\ServiceVacanciesController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::resource('services', ServiceVacanciesController::class);
    Route::post('bulk-service-delete', [ServiceVacanciesController::class, 'bulkDelete'])->name('bulk-service-delete');
    Route::post('service-status', [ServiceVacanciesController::class, 'status'])->name('services.status');
